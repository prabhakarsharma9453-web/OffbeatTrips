    ...
    <div className="min-h-screen bg-background flex flex-col overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-4 animate-fade-in-up">
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-muted-foreground">Join us and start your adventure today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                id="terms"
                className="w-4 h-4 mt-0.5 rounded border-border bg-background text-primary focus:ring-primary"
              />
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute bottom-12 right-12 max-w-md text-right">
          <h2 className="text-3xl font-serif font-bold text-white mb-4">Start Your Journey Today</h2>
          <p className="text-white/70">
            Create an account and unlock exclusive travel packages, personalized recommendations, and member-only deals.
          </p>
        </div>
      </div>
      </div>
