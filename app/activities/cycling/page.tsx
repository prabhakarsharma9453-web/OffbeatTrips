...
import { MapPin, DollarSign, Clock, Star, Bike, Globe } from "lucide-react"
...
export default function CyclingPage() {
  ...
  const allActivities = [...internationalCycling, ...domesticCycling]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 text-center">
            <p className="text-muted-foreground">
              Found <span className="text-primary font-semibold">{filteredActivities.length}</span> cycling activities
            </p>
          </div>
          ...
          {filteredActivities.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-muted-foreground text-lg">No cycling activities found.</p>
            </div>
          )}
        </div>
      </section>
