...
import { MapPin, DollarSign, Clock, Star, Plane, Globe } from "lucide-react"
...
export default function ParaglidingPage() {
  ...
  const allActivities = [...internationalParagliding, ...domesticParagliding]
  const filteredActivities =
    activeTab === "all"
      ? allActivities
      : activeTab === "international"
        ? internationalParagliding
        : domesticParagliding
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 text-center">
            <p className="text-muted-foreground">
              Found <span className="text-primary font-semibold">{filteredActivities.length}</span> paragliding activities
            </p>
          </div>
          ...
          {filteredActivities.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-muted-foreground text-lg">No paragliding activities found.</p>
            </div>
          )}
        </div>
      </section>
